...
class Chati extends CI_Controller{
	...
	public function update()
	{
		...
		//print_r("helooo:",$name);
		//print_r("hiiiiiiii",$message);exit;

		$current = new DateTime();		
		$this->Chatmode->insertMsg($name, $message, $current->getTimestamp());
		//print_r($this->Chatmode->insertMsg($name, $message, $current->getTimestamp()));exit;
	...
	*/	
	public function html_backend()
	{
		...
		//store
		$data['query'] = $this->Chatmode->getMsg();
