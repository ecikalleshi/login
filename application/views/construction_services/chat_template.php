            ...
            <div class="col-md-4">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-danger"><?=count($emplist);?> <?=$strsubTitle;?></span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>
                    </button>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    <?php if(!empty($emplist)){
						...
						?>
                        <li class="selectVendor" id="<?=$v['empId'];?>" title="<?=$v['user_name'];?>">
                          <img src="<?=$v['picture_url'];?>" alt="<?=$v['user_name'];?>" title="<?=$v['user_name'];?>">
                          <a class="users-list-name" href="#"><?=$v['user_name'];?></a>
                   ...
                   <?php }else{?>
                   	<li>
                       <a class="users-list-name" href="#">No Emp's Find...</a>
                     </li>
                  	<?php } ?>
